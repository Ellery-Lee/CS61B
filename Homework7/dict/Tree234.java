...
public class Tree234 extends IntDictionary {
  ...
  public void insert(int key) {
    // Fill in your solution here.
	  ...
	  while (position.child1 != null) {
	      if (key < position.key1) {
	        position = position.child1;
	      } else if ((position.keys == 1) || (key < position.key2)) {
	        position = position.child2;
	      } else if ((position.keys == 2) || (key < position.key3)) {
	        position = position.child3;
	      } else {
	        position = position.child4;
	      }
	      if (position.parent.keys == 3) {
			position.parent = position.parent.moveMiddle();
		}   
	  }
	...
	}else if (position.keys == 3) {
		if (key < position.key1) {
			Tree234Node n = position.moveMiddle();
			n.keys = 2;
			n.key2 = position.key1;
			n.key1 = key;
		}else if (key < position.key2) {
			Tree234Node n = position.moveMiddle();
			n.keys = 2;
			n.key2 = key;
		}else if (key < position.key3) {
			Tree234Node n = nextChild(position.moveMiddle());
			n.keys = 2;
			n.key2 = position.key3;
			n.key1 = key;
		}else {
			Tree234Node n = nextChild(position.moveMiddle());
			n.keys = 2;
			n.key2 = key;
			n.key1 = position.key3;
		}
	}
	  size++;
  }
  
  public Tree234Node nextChild(Tree234Node node) {
