...
class Tree234Node {
  ...
  Tree234Node(Tree234Node c1, Tree234Node c2, int key) {
    keys = 1;
    key1 = key;
    parent = null;
    child1 = c1;
  ...
  public void changeOne(Tree234Node c1, Tree234Node c2, int key) {
      keys = 2;
      if (key < key1) {
          key2 = key1;
          key1 = key;
  ...
  public void changeTwo(Tree234Node c1, Tree234Node c2, int key) {
      keys = 3;
      if (key < key1) {
          key3 = key2;
          key2 = key1;
  ...
  public Tree234Node moveMiddle() {
      Tree234Node newChild1 = new Tree234Node(child1, child2, key1);
      Tree234Node newChild2 = new Tree234Node(child3, child4, key3);
      if (child1 != null) {
      ...
      if (parent == null) {
          ...
          if (parent.keys == 1) {
              parent.changeOne(newChild1, newChild2, key2);
          } else {
              parent.changeTwo(newChild1, newChild2, key2);
          }
      }
      return  newChild1;
  }
