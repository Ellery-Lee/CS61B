...
public class RunIterator implements Iterator {
   ...
   */
	private DListNode_Run currentP;
  ...
  // the encoding.
  RunIterator(DList_Run list) {
    // Your solution here.  You may add parameters to the method signature.
	  currentP = new DListNode_Run();
	  currentP.next = list.head;
  }
  ...
  public int[] next() throws NoSuchElementException{
    ...
    // Replace the following line with your solution.
	  int[] runinfo = new int[4];
	  if (hasNext()) {
		runinfo[0] = currentP.next.length;
		runinfo[1] = currentP.next.red;
		runinfo[2] = currentP.next.green;
		runinfo[3] = currentP.next.blue;
