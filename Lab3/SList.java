...
/*	if (head == null) {
  ...
  public static void main (String[] args) {
	...
	SList list_part1 = new SList();
	list_part1.insertEnd(6);
	list_part1.insertEnd(9);
	list_part1.insertEnd(12);
	System.out.println("step1:" + list_part1.toString());
	
	list_part1.insertFront(3);
	list_part1.insertEnd(15);
	System.out.println("step2:" + list_part1.toString());
